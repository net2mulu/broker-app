              ...
              <div className="col-lg-6 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
                <div className="hero-text">
                  ...
                  <strong
                    ...
                    data-aos-delay={200}
                  >
                    <i className="fa fa-phone mr-2" /> 07117492 | 07633438
                  </strong>
                </div>
              </div>
              ...
              <div className="col-lg-7 mx-auto col-md-10 col-12">
                <div className="about-info">
                  <h2 className="mb-4" data-aos="fade-up">
                    We are the best <strong>brokers</strong> in ertirea with
                    valuable connections
                  </h2>
                  <p className="mb-0" data-aos="fade-up">
                    Make sure to contact us before you decide on renting,buying
                    a place like (villas, appartments, comercial shops) in
                    ertirea.
                  </p>
                </div>
                <div
            ...
            <div className="row">
              <div className="col-lg-12 col-12">
                ...
                <div className="owl-carousel owl-theme" id="project-slide">
                  ...
                  >
                    <img
                      src="http://t3.gstatic.com/licensed-image?q=tbn:ANd9GcQ2Zakzmja4CiOhjiMkortp22AzAO_VYAn2fMM7uqYoMzAcuvvDuwB_VcDI2vqFP7KI"
                      className="img-fluid"
                      alt="project image"
                    />
                  ...
                  <div className="item project-wrapper" data-aos="fade-up">
                    <img
                      src="https://i.pinimg.com/originals/1e/29/26/1e292677d2a1c2feb0ea612f48356713.jpg"
                      className="img-fluid"
                      alt="project image"
                    />
                    <div className="project-info">
                  ...
                  <div className="item project-wrapper" data-aos="fade-up">
                    <img
                      src="https://www.ribapix.com/images/thumbs/036/0366942_RIBA4474_600.jpeg"
                      className="img-fluid"
                      alt="project image"
                    />
                    <div className="project-info">
                  ...
                  <div className="item project-wrapper" data-aos="fade-up">
                    <img
                      src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/56379526.jpg?k=cc74113269f666ce89437125d0bc4e3ae72ef2d9e582e46d0ef2e1d82610feaa&o=&hp=1"
                      className="img-fluid"
                      alt="project image"
                    />
                    <div className="project-info">
                  ...
                  <div className="item project-wrapper" data-aos="fade-up">
                    <img
                      src="https://518192-1674976-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2017/11/dsc_1150-dsc_1154-765x510.jpg"
                      className="img-fluid"
                      alt="project image"
                    />
                    <div className="project-info">
            ...
            <div className="row">
              <div className="col-lg-5 mx-lg-auto col-md-8 col-10">
                <h1
                  ...
                  data-aos-delay={100}
                >
                  We Offer <strong>Assured</strong> Dealership.
                </h1>
              </div>
              <div
